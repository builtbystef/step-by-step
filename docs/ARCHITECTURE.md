...
`step_by_step_api.accounts` is who a person is and how they prove it. Email is the sole identity, there are no passwords, and the tenant is the Organization (ADR 0005). Seven modules, and `orgs.py` below is the eighth:
